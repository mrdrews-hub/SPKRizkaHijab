...
<div class="col-lg-12">
    ...
    <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header"><h2>Table 1 - Nilai Awal</h2></div>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                                <tr class="active">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header"><h2>Table 2 - Dihitung sesuai sifat cost atau benefit</h2></div>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                                <tr class="active">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header"><h2>Table 3 - Dikali dengan bobot</h2></div>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                                <tr class="active">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header"> <h2>Table 4 - Dijumlah sesuai dengan Alternatif dan di dapat hasil rangking</h2></div>
                    <div class="card-body">
                        <table class="table">
                                <thead>
                                    <tr class="active">
                    ...
                    if ($value->Rangking == 1) {
                        ...
                        <div class="alert alert-primary" role="alert">
                            <h4><b>Kesimpulan : </b> Dari hasil perhitungan yang dilakukan menggunakan metode SAW,
                                Baju terbaik untuk di pilih adalah
